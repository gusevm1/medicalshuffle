            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-primary-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <path strokeLinecap="round" strokeWidth={2} d="M12 6a6 6 0 0 1 6 6" />
                  <path strokeLinecap="round" strokeWidth={2} d="M12 3a9 9 0 0 1 9 9" />
                  <path strokeLinecap="round" strokeWidth={2} d="M12 18a6 6 0 0 1-6-6" />
                  <path strokeLinecap="round" strokeWidth={2} d="M12 21a9 9 0 0 1-9-9" />
                </svg>
              </div>
              <div>
                <h1 className="text-xl font-bold text-card-foreground">
